...
IF DB_ID('PharmaSupplyChainDB') IS NOT NULL
BEGIN
    ALTER DATABASE PharmaSupplyChainDB SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE PharmaSupplyChainDB;
END;
GO
...
CREATE TABLE PARTNER (
    ...
    encrypted_contact_info   VARBINARY(MAX) NULL,
...
CREATE TABLE LICENSE (
    ...
    encrypted_license_number VARBINARY(MAX) NULL,
